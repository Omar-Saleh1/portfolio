    ...
    <div className="bg-gray-950 text-white scroll-smooth">
      ...
      >
        <div className="flex justify-around items-center max-w-7xl mx-auto">
          ...
          {/* Desktop Menu */}
          <ul className="hidden md:flex gap-6 text-3x1 items-center justify-center">
            <li>
      ...
      >
        ...
        >
          <h2 className="text-5xl font-extrabold">
            Hi Iam <span className="text-cyan-400">Omar</span> 
          </h2>
          <p className="text-lg text-gray-300 max-w-xl">
            A passionate{" "}
            <span className="text-cyan-400">Front-End Developer</span> crafting
            creative and scalable web apps.
          </p>
          <div className="flex gap-4 justify-center md:justify-start flex-wrap">
            <a
              href="#projects"
              className="bg-cyan-500 hover:bg-cyan-600 px-6 py-2 rounded-full font-semibold"
            >
              View Projects
            </a>
            <a
            ...
            >
              ...
              <a
                href="https://github.com/Omar-Saleh1"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/omar-abdelmoniam-30313b349?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-cyan-400 transition"
              >
              ...
              <a
                href="mailto:os6100050@gmail.com"
                className="hover:text-cyan-400 transition"
              >
                <FaEnvelope />
              </a>
      ...
      >
        <h3 className="text-3xl font-bold mb-12 border-b-4 border-cyan-400 inline-block">
          Skills
        </h3>
